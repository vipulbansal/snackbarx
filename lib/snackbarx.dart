...
class SnackbarX {
  ...
  /// Root [Navigator] key for global snackbars. Set on [MaterialApp.navigatorKey].
  ...
  /// Pass [context] when not using [navigatorKey] on [MaterialApp].
  ...
  /// app's initialization code. By default [navigatorKey] is [SnackbarX.navigatorKey];
  /// pass a different key if you assign another key to [MaterialApp.navigatorKey].
